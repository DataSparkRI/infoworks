...
def get_school_indicator_value(school, school_year, dimension_y):
    try:
        ...
        return school_indicator_dataset.get_objects('This School', dimension_y).key_value
    except:
        return None
...
def get_district_indicator_value(district, school_year, dimension_y):
    try:
        ...
        return district_indicator_dataset.get_objects('This District', dimension_y).key_value
    except:
        return None
...
def get_state_indicator_value(state, school_year, dimension_y):
    try:
        ...
        return state_indicator_dataset.get_objects('Statewide', dimension_y).key_value
    except:
        return None