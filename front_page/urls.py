...
urlpatterns = [
    ...
    url(r'^school/(?P<slug>[\w-]+)/history/(?P<school_year>[\w-]+)/$', views.schools_history_detail, name="schools_history_detail"),
    ...
    url(r'^district/(?P<slug>[\w-]+)/history/(?P<school_year>[\w-]+)/$', views.districts_history_detail, name="districts_history_detail"),
    ...
    url(r'^about/(?P<slug>[\w-]+)/$', views.about_slug, name="about_slug_page"),
    ]
